...
const fieldTitleMap: Record<string, string> = {
  ...
  CRYPTOPANIC_OPENCLI_ENABLED: 'CryptoPanic OpenCLI 兜底',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  CRYPTOPANIC_API_TOKEN: '用于 BTC/加密货币最新资讯检索的 CryptoPanic 官方 API Token。',
  CRYPTOPANIC_OPENCLI_ENABLED: '本地桌面可选兜底；开启后可在 CryptoPanic API 不可用时通过 OpenCLI 浏览器登录态读取页面，服务端部署建议关闭。',
