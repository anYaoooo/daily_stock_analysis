...
const REPORT_TEXT = {
  zh: {
    ...
    strategyPoints: '策略点位',
    sniperLevels: '狙击点位',
    directionalPlans: '多空策略',
    longPlan: '多单策略',
    shortPlan: '空单策略',
    intradayPlan: '小时线日内计划',
    dailyConstraint: '日线约束',
    analysisMode: '周期',
    direction: '方向',
    entryPrice: '入场价',
    entryZone: '入场区间',
  ...
  en: {
    ...
    directionalPlans: 'Directional Plans',
    longPlan: 'Long Plan',
    shortPlan: 'Short Plan',
    intradayPlan: 'Hourly Intraday Plan',
    dailyConstraint: 'Daily Constraint',
