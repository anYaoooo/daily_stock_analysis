...
| [BTC Trading Assistant Roadmap](btc-trading-assistant-roadmap.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) | BTC-only convergence, structured trading plans, one-click backtesting, review UX, risk controls, and trading API rollout |
| [BTC Multi-Task Training Baseline](btc-training-baseline.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) | Closed-OHLCV features, return-distribution/volatility/regime labels, and purged walk-forward offline evaluation |
| [BTC Transformer Research Module](btc-transformer-research.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) | PatchTST, iTransformer, representation fusion, multi-task training, and walk-forward experiments |
| [Windows Migration and RX 9070 XT Training Setup](windows-rx9070xt-migration.md) <sub><sub>![P2 Badge](https://img.shields.io/badge/P2-yellow?style=flat)</sub></sub> (Chinese-only) | Move the workspace, database, Web UI, and AMD ROCm/PyTorch training environment to a clean Windows PC |
