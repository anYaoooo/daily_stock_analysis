...
class LLMChannelConfigTestCase(unittest.TestCase):
    ...
    def test_branded_gateway_channels_are_skipped_in_btc_only_mode(self, _mock_parse_yaml, _mock_setup_env) -> None:
        env = {
            "LLM_CHANNELS": "anspire,aihubmix",
        ...
        self.assertEqual(config.anspire_api_keys, [])
