...
- `CLAUDE.md` must point to `AGENTS.md`; on Linux/macOS it remains a symlink, while Windows without symlink privileges may use a file containing exactly `AGENTS.md`.
