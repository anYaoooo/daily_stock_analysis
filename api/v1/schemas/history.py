...
class DirectionalStrategyPlan(BaseModel):
    ...
    execution_ladder: Optional[Dict[str, Any]] = Field(None, description="BTC 试仓、确认加仓与失效的分步执行计划")
    execution_contract: Optional[Dict[str, Any]] = Field(None, description="BTC 机器可执行入场与持有契约")
