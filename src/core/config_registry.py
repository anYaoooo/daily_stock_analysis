...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "CRYPTOPANIC_API_TOKEN": {
        "title": "CryptoPanic API Token",
        "description": "CryptoPanic API token for BTC and crypto latest-news search.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "CRYPTOPANIC_OPENCLI_ENABLED": {
        "title": "CryptoPanic OpenCLI Fallback",
        "description": "Enable local OpenCLI browser fallback for CryptoPanic when the API token is absent or unavailable. Desktop/local use only.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "help_key": "settings.data_source.search_api_keys",
        "examples": [
            "CRYPTOPANIC_OPENCLI_ENABLED=false",
            "CRYPTOPANIC_OPENCLI_ENABLED=true",
        ],
        "warning_codes": [],
    },
    "MINIMAX_API_KEYS": {
